            ...
            if(getamt == 0) {
                ...
                if(getamt >=minAm){
                    if(raisedAm+ getamt <= totalAm){
                        if(raisedAm+ getamt == totalAm)
                            ibsListener.onButtonClicked(name, String.valueOf(getamt) , String.valueOf(availableequity), String.valueOf(new BigDecimal(String.valueOf(raisedAm+getamt)).stripTrailingZeros().toPlainString()), "", true);
                        else
                            ibsListener.onButtonClicked(name, String.valueOf(getamt) , String.valueOf(equityforamt), String.valueOf(new BigDecimal(String.valueOf(raisedAm+getamt)).stripTrailingZeros().toPlainString()), "", false);
...
//                            ibsListener.onButtonClicked(name, String.valueOf(getamt), availableequitytv.getText().toString(), String.valueOf(raisedAm+getamt), "", true);
                            ibsListener.onButtonClicked(name, String.valueOf(getamt), availableequitytv.getText().toString(), String.valueOf(new BigDecimal(String.valueOf(raisedAm+getamt)).stripTrailingZeros().toPlainString()), "", true);
                        });
